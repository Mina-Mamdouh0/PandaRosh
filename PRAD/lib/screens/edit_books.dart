...
class EditBooks extends StatefulWidget {
  EditBooks({Key? key}) : super(key: key);

  @override
  State<EditBooks> createState() => _EditMoviesState();
}

class _EditMoviesState extends State<EditBooks> {
...
/*    showDialog(
    ...
    try {
      ...
      bookID = prefs.getString('bookID').toString();

      final url = Uri.parse(
          'https://pandarosh-91270-default-rtdb.firebaseio.com/booksInfo/$bookID.json');
...
/*          extractedData?.forEach((Key, value) {
  ...
  void uploadEpisImage() {
    ...
    episImageRef = 'Episodes/books/''${getRandomString(10)}${DateTime.now()}.jpg';
  ...
  Future<void> getEpisodesRow() async {
    ...
    try {
      //s&m
      final url = Uri.parse(
          'https://pandarosh-91270-default-rtdb.firebaseio.com/booksEpis.json?orderBy="movie"&equalTo="$bookID"');
...
/*                                      CustomTextFiled(
  ...
  void uploadEpisode(myFile) {
    ...
    audioRef = 'Episodes/books/' '${getRandomString(10)}${DateTime.now()}.mp3';
  ...
  void uploadEpis() async {
    try {
      final url = Uri.parse('https://pandarosh-91270-default-rtdb.firebaseio.com/booksEpis.json');
  ...
  void uploadEpis2(index) async {
    try {
      ...
      await desertRef.delete().then((value) async {
        final url = Uri.parse('https://pandarosh-91270-default-rtdb.firebaseio.com/booksEpis/${firstList[index].idToEdit}.json');
      ...
      await refBack.delete().then((value) async{
        ...
        await refProfile.delete().then((value) async{
          ...
          await http.delete(url).then((value) async{
            ...
            log("deleted booksInfo: $bookID");

            final url = Uri.parse(
                'https://pandarosh-91270-default-rtdb.firebaseio.com/books.json?orderBy="info"&equalTo="$bookID"');
            ...
            await http.get(url).then((value) async{
              ...
              log("get books id: $idd");

              final url = Uri.parse(
                  'https://pandarosh-91270-default-rtdb.firebaseio.com/books/$idd.json');

              // Delete s&m
              await http.delete(url).then((value) async{
                log("deleted books: $idd");
                ...
                await http.get(urlCat).then((valueCat) async {
                  ...
                  await http.get(urlWrit).then((valueWrit) async {
                    ...
                    await http
                        .patch(
                      Uri.https('pandarosh-91270-default-rtdb.firebaseio.com', '/writers/$writerNameID.json'),
                      body: json.encode({
                        'num': (int.parse(json.decode(valueWrit.body).toString()) - 1).toString(),
                      }),
                    ).then((value) async{
                      ...
                      await http
                          .patch(
                        Uri.https('pandarosh-91270-default-rtdb.firebaseio.com', '/categories/$categoryID.json'),
                        body: json.encode({
                          'num': (int.parse(json.decode(valueCat.body).toString()) - 1).toString(),
                        }),
                      ).then((value) async{
                        ...
                        if(firstList.isEmpty){
                          ...
                          for (int i = 0; i < firstList.length; i++) {
                            ...
                            if(i == firstList.length - 1){
                              ...
                              final desertRef = FirebaseStorage.instance.ref().child(firstList[i].ref);
                              ...
                              await desertRef.delete().then((value) async{
                                ...
                                final url = Uri.parse('https://pandarosh-91270-default-rtdb.firebaseio.com/booksEpis/${firstList[i].idToEdit}.json');

                                await http.delete(url).then((value) {

                                  log("deleted booksEpis: ${firstList[i].idToEdit}");
  ...
  void startAudio() async {
    ...
    try {
      await assetsAudioPlayer.open(
        Audio.network("https://firebasestorage.googleapis.com/v0/b/pandarosh-91270.appspot.com/o/Episodes%2Fs%26m%2FXCsWemPqdW2022-05-22%2001%3A00%3A43.032.mp3?alt=media&token=61fece43-fc56-4bcc-87db-095b375df2ec"),
      ).then((value) {
...
*/
  ...
  void EditEpisName(index) async {
    ...
    try {
      final url = Uri.parse(
          'https://pandarosh-91270-default-rtdb.firebaseio.com/booksEpis/${firstList[index].idToEdit}.json');
  ...
  void uploadEpisodePromo(myFile) async{
    ...
    audioRefPromo = 'Episodes/books/' '${getRandomString(10)}${DateTime.now()}.mp3';
            ...
            child: Column(
              ...
              children: [
                RichText(text: TextSpan(
                    children:  [
                      TextSpan(text: 'اسم الكتاب : ',style: TextStyle(
                          fontSize: 30,
                          fontWeight: FontWeight.bold,
                          color: Colors.black
                      )),
                ...
                RichText(text: TextSpan(
                    children:  [
                      ...
                      TextSpan(text: category,style: TextStyle(
                          fontSize: 25,
                          fontWeight: FontWeight.bold,
                          color: Colors.blueAccent
                      )),
                ...
                RichText(text: TextSpan(
                    children:  [
                      TextSpan(text: 'اسم الكاتب : ',style: TextStyle(
                          fontSize: 30,
                          fontWeight: FontWeight.bold,
                          color: Colors.black
                      )),
                      TextSpan(text: writerName,style: TextStyle(
                          fontSize: 25,
                          fontWeight: FontWeight.bold,
                          color: Colors.blueAccent
                      )),
                ...
                RichText(text: TextSpan(
                    children:  [
                      TextSpan(text: 'عن : ',style: TextStyle(
                          fontSize: 30,
                          fontWeight: FontWeight.bold,
                          color: Colors.black
                      )),
                ...
                RichText(text: TextSpan(
                    children:  [
                      TextSpan(text: 'الارباح  : ',style: TextStyle(
                          fontSize: 30,
                          fontWeight: FontWeight.bold,
                          color: Colors.black
                      )),
                      TextSpan(text: profits,style: TextStyle(
                          fontSize: 25,
                          fontWeight: FontWeight.bold,
                          color: Colors.blueAccent
                      )),
                      TextSpan(text: 'جنيه مصري',style: TextStyle(
                          fontSize: 25,
                          fontWeight: FontWeight.bold,
                          color: Colors.blueAccent
                      )),
...
/*                RichText(text: TextSpan(
                    children:  [
                      TextSpan(text: 'كم الوقت  : ',style: TextStyle(
                          fontSize: 30,
                          fontWeight: FontWeight.bold,
                          color: Colors.black
                      )),
                ...
                RichText(text: TextSpan(
                    children:  [
                      TextSpan(text: 'كم حلقه  : ',style: TextStyle(
                          fontSize: 30,
                          fontWeight: FontWeight.bold,
                          color: Colors.black
                      )),
                      TextSpan(text: episodesNum,style: TextStyle(
                          fontSize: 25,
                          fontWeight: FontWeight.bold,
                          color: Colors.blueAccent
                      )),
                ...
                Row(
                  children: [
                    Expanded(child: MaterialButton(onPressed: () async{
                      final prefs = await SharedPreferences.getInstance();
                      prefs.setString('bookID', bookID);

                      Get.to(const EditButtonBookss());
                      },
                              ...
                              child: Directionality(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text("سيتم مسح الكتاب بالكامل بكل تفاصيله وحلقاته"),
                                  ],
                                ),
                              ),
                            ),
...
class EditButtonBooks extends StatefulWidget {
  const EditButtonBooks({Key? key}) : super(key: key);

  @override
  _EditButtonBooksState createState() => _EditButtonBooksState();
}

class _EditButtonBooksState extends State<EditButtonBooks> {
  var formKey=GlobalKey<FormState>();
  ...
  void uploadN() async {
    try {
      Uri url =
      Uri.https('pandarosh-91270-default-rtdb.firebaseio.com', '/books.json');
  ...
  void uploadImage() {
    ...
    firstRef = 'Images/books/''${getRandomString(10)}${DateTime.now()}.jpg';
  ...
  void uploadImage2() {
    ...
    secondRef = 'Images/books/''${getRandomString(10)}${DateTime.now()}.jpg';
